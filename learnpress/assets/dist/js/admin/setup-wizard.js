...
class SetupWizard {
  ...
  resetNextButtons() {
    this.elSetupForm.querySelectorAll('.button-next').forEach(button => {
      ...
      lpAssetsJsPath_utils_js__WEBPACK_IMPORTED_MODULE_0__.lpSetLoadingEl(button, 0);
    });
  }
  initToggles() {
    lpAssetsJsPath_utils_js__WEBPACK_IMPORTED_MODULE_0__.toggleEnable((toggle, isEnabled) => {
      const input = toggle.querySelector('.lp-toggle-enable__input');
  ...
  importDemoCourse() {
    ...
    this.demoCourse.querySelectorAll('button').forEach(button => {
      ...
      lpAssetsJsPath_utils_js__WEBPACK_IMPORTED_MODULE_0__.lpSetLoadingEl(button, 1);
    });
  ...
  saveStep(button) {
    ...
    const dataSend = lpAssetsJsPath_utils_js__WEBPACK_IMPORTED_MODULE_0__.getDataOfForm(this.elSetupForm);
