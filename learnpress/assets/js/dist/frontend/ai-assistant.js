...
class AIAssistantWidget {
  ...
  appendQuizReviewCard(review) {
    ...
    card.appendChild(this.createEl('div', 'lp-ai-assistant__quiz-head', `Question ${review.question_index + 1}/${total}`));
    ...
    feedbackEl.appendChild(this.createEl('strong', '', review.is_correct ? this.config.i18n.quizCorrectTitle : this.config.i18n.quizWrongTitle));
  ...
  renderQuizState() {
    ...
    card.appendChild(this.createEl('div', 'lp-ai-assistant__quiz-head', `Question ${currentIndex + 1}/${quiz.total || options.length}`));
